...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.String(length=36), nullable=False),
        sa.Column(
            "plan", sa.Enum("FREE", "PRO", "TEAM", name="plantier"), nullable=False
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        op.f("ix_usage_counters_user_id"), "usage_counters", ["user_id"], unique=False
    )
    op.create_table(
        "exports",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("QUEUED", "RENDERING", "COMPLETED", "FAILED", name="exportstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_graphics_overlays_project_id"),
        "graphics_overlays",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_graphics_overlays_user_id"),
        "graphics_overlays",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("OWNER", "EDITOR", "COMMENTER", "VIEWER", name="projectrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("OWNER", "EDITOR", "VIEWER", name="teamrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            sa.Enum(
                "FRAME_EXTRACT", "AI_GENERATED", "UPLOADED", name="thumbnailsource"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_thumbnails_project_id"), "thumbnails", ["project_id"], unique=False
    )
    op.create_index(
        op.f("ix_thumbnails_user_id"), "thumbnails", ["user_id"], unique=False
    )
    op.create_table(
        "captions",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_captions_project_id"), "captions", ["project_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "CHANGES_REQUESTED", name="reviewstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_reviews_project_id"), "reviews", ["project_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_graphics_overlays_project_id"), table_name="graphics_overlays"
    )
