...
description: Specialized security analysis agent for Creator Zone. Use before releases, after touching auth/payment/storage, or when a security concern is raised.
---
