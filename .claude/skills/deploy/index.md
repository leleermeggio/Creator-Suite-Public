...
Structured deployment checklist for CazZone Creator Suite.
...
curl -s -X POST http://127.0.0.1:8000/auth/login \
  ...
  -d '{"email":"dev@cazzone.local","password":"CazZone2024!"}' | python -m json.tool
```
...
- [ ] Login with `dev@cazzone.local / CazZone2024!` works
